...
/**
 * Extend the Beam {@code org.apache.beam.sdk.io.hdfs.HDFSFileSource} for extra functionality.
 *
 * <ul>
 ...
 *
 * @param <K>
 *         The key type provided by this source.
 * @param <V>
 *         The value type provided by this source.
 * @param <SourceT>
 *         The concrete implementation class for the source.
 */
public abstract class FileSourceBase<K, V, SourceT extends FileSourceBase<K, V, SourceT>>
    ...
    protected FileSourceBase(UgiDoAs doAs, String filepattern, Class<? extends FileInputFormat<?, ?>> formatClass,
            Class<K> keyClass, Class<V> valueClass, ExtraHadoopConfiguration extraConfig,
     ...
     * for the given split.
     *
     * @param serializableSplit
     *         the split that the source is processing.
    ...
    @Override
    protected List<? extends BoundedSource<KV<K, V>>> doAsSplitIntoBundles(long desiredBundleSizeBytes,
