...
public class SimpleFileIOComponentFamilyDefinition extends AbstractComponentFamilyDefinition
    ...
    public static final String MAVEN_DEFAULT_RUNTIME_URI =
            "mvn:" + MAVEN_GROUP_ID + "/" + MAVEN_DEFAULT_RUNTIME_ARTIFACT_ID;

    public static final String MAVEN_DEFAULT_DI_RUNTIME_URI =
            "mvn:" + MAVEN_GROUP_ID + "/" + MAVEN_DEFAULT_DI_RUNTIME_ARTIFACT_ID;
