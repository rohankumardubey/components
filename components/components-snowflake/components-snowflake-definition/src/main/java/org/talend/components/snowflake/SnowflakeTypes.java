...
public final class SnowflakeTypes {
    ...
    public static final DbmsType TINYINT = new DbmsType("TINYINT");
    public static final DbmsType BYTEINT = new DbmsType("BYTEINT");
    ...
    //see : https://docs.snowflake.com/en/sql-reference/data-types-text.html
    ...
    public static final DbmsType NCHAR = new DbmsType("NCHAR", false, true);
    public static final DbmsType NVARCHAR = new DbmsType("NVARCHAR", false, true);
    public static final DbmsType NVARCHAR2 = new DbmsType("NVARCHAR2", false, true);
    public static final DbmsType CHAR_VARYING = new DbmsType("CHAR VARYING", false, true);
    public static final DbmsType NCHAR_VARYING = new DbmsType("NCHAR VARYING", false, true);

    public static final DbmsType GEOGRAPHY = new DbmsType("GEOGRAPHY");
    ...
    static {
        ...
        allTypes.put("TINYINT", TINYINT);
        allTypes.put("BYTEINT", BYTEINT);
        ...
        allTypes.put("NCHAR", NCHAR);
        allTypes.put("NVARCHAR", NVARCHAR);
        allTypes.put("NVARCHAR2", NVARCHAR2);
        allTypes.put("CHAR VARYING", CHAR_VARYING);
        allTypes.put("NCHAR VARYING", NCHAR_VARYING);

        allTypes.put("GEOGRAPHY", GEOGRAPHY);
    }
