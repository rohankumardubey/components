...
public abstract class SalesforceComponentTestIT extends SalesforceTestBase {
    ...
    public void testInputProps() throws Throwable {
        TSalesforceInputProperties props =
                (TSalesforceInputProperties) new TSalesforceInputDefinition().createProperties();
        ...
        assertTrue(queryAdvancedForm.getChildForm(props.connection.getName())
                .getWidget(props.connection.bulkConnection.getName())
                .isHidden());
        ...
        assertFalse(queryAdvancedForm.getChildForm(props.connection.getName())
                .getWidget(props.connection.httpChunked.getName())
                .isHidden());
        assertTrue(queryAdvancedForm.getChildForm(props.connection.getName())
    ...
    public void testWizard() throws Throwable {
        ...
        assertEquals("Complete these fields in order to connect to your Salesforce account.",
                connFormWizard.getSubtitle());
        ...
        assertTrue(
                ((PresentationItem) connFormWizard.getWidget("advanced").getContent()).getFormtoShow()
                        + " should be == to "
                        + advancedForm,
                ((PresentationItem) connFormWizard.getWidget("advanced").getContent()).getFormtoShow() == advancedForm);

        Object image =
                getComponentService().getWizardPngImage(SalesforceConnectionWizardDefinition.COMPONENT_WIZARD_NAME,
        ...
        connProps = (SalesforceConnectionProperties) DaikonLegacyAssertions.checkAndValidate(getComponentService(),
                connFormWizard,
    ...
    public void testModuleWizard() throws Throwable {
        ...
        SalesforceConnectionProperties connProps =
                (SalesforceConnectionProperties) connectionWizardForm.getProperties();
    ...
    public void testLogin() throws Throwable {
        ...
        props = (SalesforceConnectionProperties) DaikonLegacyAssertions.checkAndValidate(getComponentService(), f,
                "testConnection",
                props);
    ...
    public void testSchema() throws Throwable {
        testSchemaWithAPIVersion("52.0");
        testSchemaWithAPIVersion("51.0");
        testSchemaWithAPIVersion("50.0");
        testSchemaWithAPIVersion("49.0");
        testSchemaWithAPIVersion("48.0");
    ...
    public void testInputConnectionRef() throws Throwable {
        ...
        props.connection.referencedComponent.referenceType.setValue(
                ComponentReferenceProperties.ReferenceType.THIS_COMPONENT);
    ...
    public void testSchemaSerialized() throws Throwable {
        ...
        Schema reject =
                SchemaBuilder.record("Reject").fields().name("A").type().stringType().noDefault().name("B").type()
